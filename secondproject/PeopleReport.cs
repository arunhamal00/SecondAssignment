class PeopleReport
{
    ...
    {
        string filePath=@"E:\SecondAssignment\secondproject\Data\males.csv";
    ...
    {
        string filePath = @"E:\SecondAssignment\secondproject\Data\adultfemales.csv";
    ...
    {
        string filePath = @"E:\SecondAssignment\secondproject\Data\dotcomuser.csv";
